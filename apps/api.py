...
class Contact(Resource):
    ...
    def get(self, cpf):
        ...
        if contact is None:
            return resp_ok(
                'Contact',
                MSG_NO_DATA.format('Contacts'),
            )
        else:
            return resp_ok(
                'Contact',
                MSG_RESOURCE_RETRIEVED.format('Contacts'),
                data=contact,
            )
    ...
    def put(self, cpf):
        ...
        return resp_ok(
            'Contact',
            MSG_RESOURCE_UPDATED.format('Contacts'),
            data=contact,
        )
...
class Contacts(Resource):
    ...
    def post(self):
        ...
        return resp_created(
            'Contacts',
            MSG_RESOURCE_CREATED.format('Contacts'),
            data=contact,
        )
